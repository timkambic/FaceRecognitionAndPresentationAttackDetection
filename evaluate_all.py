...
# fpr_replay3,tpr_replay3,auc_replay3,HTER_replay3,EER_replay3 = evaluate("scores/scores_model3_Replay_28122018.txt", "scores/truelabels_model3_Replay28122018.txt")
...
# plt.plot(fpr_replay3, tpr_replay3, color='green', lw=2, label='ReplayAttack model3 (area = %0.3f)' % auc_replay3)
